...
@ img/TODO_cas_05.jpg | (doplniť: interiér stanice Lyon-Part-Dieu — Wikimedia Commons, CC BY-SA)
...
- 👩 Andrea, ktorá organizuje
- 👦 Eric
- 👨 Marek, kolega Andrey

Eric a Andrea si vykajú. Andrea a Marek si tykajú.
...
> Eric, kedy máte čas?
> Quand avez-vous le temps = kedy máte čas

! 👦 Lundi après-midi.
> V pondelok poobede.
> Lundi après-midi = v pondelok poobede
...
+ „jusqu'à“ znamená až do, do.

! 👩 Et mercredi ?
> A v stredu?
> Et mercredi = a v stredu

! 👨 Mercredi oui. Mais pas tôt.
> V stredu áno. Ale nie skoro.
> Mercredi oui = v stredu áno
> mais pas tôt = ale nie skoro
...
! 👨 Moi, je vais sans doute être en retard. Le bus est toujours en retard.
> Ja asi budem meškať. Autobus vždy mešká.
> Moi = ja
> je vais sans doute être en retard = asi budem meškať
> le bus est toujours en retard = autobus vždy mešká
...
> Kedy máš stretnutie?
> Quand as-tu = kedy máš
> ton rendez-vous = stretnutie

! Jeudi matin, j'y vais tôt.
> Vo štvrtok ráno idem skoro.
> Jeudi matin = vo štvrtok ráno
> j'y vais = idem
> tôt = skoro

! J'attends déjà depuis vingt minutes.
> Čakám už dvadsať minút.
> J'attends déjà = čakám už
> depuis vingt minutes = dvadsať minút

! J'arrive à huit heures moins le quart.
> Prídem o trištvrte na osem.
> J'arrive = prídem
> à huit heures moins le quart = o trištvrte na osem
